...
public:
    ...
    /**
     * @brief Конструктор копирования (создаёт полином, копируя коэффициенты из заданного полинома)
     * 
    ...
    int size();
    /**
     * @brief Присваивает полиному заданный полином и возвращает ссылку на текущий полином
     * 
     * @param rhs Полином
     * @return Polynimial& Ссылка на текцщий полином
     */
    Polynimial &operator=(const Polynimial &rhs);
    /**
     * @brief Возрщает ссылку на заданный коэффициент полином
     * 
     * @param rhs Номер коэффициента
     * @return double& Ссылка на коэффициента
     */
